myApp.factory('userFactory',['$http',function($http){
  console.log("successfully reached factory")
  var users = [];
  var factory ={};
  var topics = [];
  var topic = {};
  ...
  factory.add = function(number,callback){
...
factory.sub = function(number,callback){
  console.log(number);
  diff = number.a-number.b
  console.log("diff between a and b is", diff)
  callback(diff);
}

factory.foo = function(number,callback){
  console.log(number);
  foo = number.a/100 +number.b * number.c/10
  console.log("foo for these parameters was", foo)
  callback(foo);
}

factory.random = function(number,callback){

  console.log(number);
  random = number.a*50 + 100 /35;
  console.log("random for this was", random)
  callback(random);
}
